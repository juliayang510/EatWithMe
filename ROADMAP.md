...
11. ✅ **Map/Explore view** — Interactive map with Cardinal restaurant pins (Gold for "Happy Hour"/sponsored), and a bottom-sheet/carousel of nearby restaurant cards with filter chips (cuisine, price). Pin clustering skipped — the seed set (12 restaurants) doesn't need it yet.
12. ✅ **Messaging (DMs)** — Cardinal/gray bubble chat backed by a real Socket.io + Express server (in-memory), plus a streak counter pinned to the top of the thread.
